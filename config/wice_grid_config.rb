if defined?(Wice::Defaults)
  ...
  Wice::Defaults::DEFAULT_TABLE_CLASSES = ['list', 'issues']
  ...
  Wice::Defaults::QUERY_STORE_MODEL = 'FinWiceGridSerializedQuery'
  ...
  Wice::Defaults::CALENDAR_ICON = "/plugin_assets/redmine_payments/images/icons/grid/calendar_view_month.png"
